	...
	$bg_field = array(
		...
		'picker'       => array(
			'effect' => array(
				...
				'value'   => 'none',
				'search'  => __( 'Search backgrounds…', 'fw' ),
				'layout'  => 'tabs',
				'choices' => upw_ae_group_tiles(
					...
					array(
						'grp_gradient' => array( 'label' => __( 'Gradient & Glow', 'fw' ), 'ids' => array( 'aurora', 'borealis', 'gradient', 'conic', 'mesh', 'nebula', 'orbs', 'spotlight', 'rays' ) ),
						'grp_particles' => array( 'label' => __( 'Particles', 'fw' ), 'ids' => array( 'particles', 'confetti', 'bubbles', 'bokeh', 'fireflies', 'snow', 'rain', 'meteors', 'constellation', 'starfield' ) ),
						'grp_geometric' => array( 'label' => __( 'Geometric', 'fw' ), 'ids' => array( 'dots', 'grid', 'hexgrid', 'pgrid', 'halftone', 'circuit', 'topo' ) ),
						'grp_fluid' => array( 'label' => __( 'Motion & Fluid', 'fw' ), 'ids' => array( 'flow', 'waves', 'ripple', 'blobs', 'shapes', 'orbits' ) ),
						'grp_fx' => array( 'label' => __( 'Digital FX', 'fw' ), 'ids' => array( 'matrix', 'noise', 'scanlines' ) ),
					),
					array( 'none' )
				),
			),
