...
add_filter( 'sc_animation_fields', function ( $fields ) {
	...
	$ix      = function ( $file, $label ) use ( $ix_base ) {
		return array(
			'small' => array( 'src' => $ix_base . '/' . $file . '.svg', 'height' => 53 ),
	...
	$fields['interaction'] = array(
		...
		'picker'       => array(
			'effect' => array(
				...
				'value'   => 'none',
				'search'  => __( 'Search hover effects…', 'fw' ),
				'layout'  => 'tabs',
				'choices' => array(
					'grp_motion' => array( 'label' => __( 'Motion', 'fw' ), 'choices' => array(
					...
					'grp_filter' => array( 'label' => __( 'Filter & Color', 'fw' ), 'choices' => array(
					...
					'grp_border' => array( 'label' => __( 'Border & Outline', 'fw' ), 'choices' => array(
					...
					'grp_text' => array( 'label' => __( 'Text', 'fw' ), 'choices' => array(
					...
					'grp_cursor' => array( 'label' => __( 'Cursor', 'fw' ), 'choices' => array(
					...
					'grp_surface' => array( 'label' => __( 'Surface & Image', 'fw' ), 'choices' => array(
